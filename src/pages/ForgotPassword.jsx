                ...
                <form onSubmit = {handleOnSubmit}>
                  ...
                  {!emailSent && (
                      <label className="w-full">
                        ...
                        <input required type="email" name="email" value={email} onChange={(e) => setEmail(e.target.value)} placeholder="Enter email address" className='w-full bg-richblack-800 p-3 rounded-lg inputShadow text-base font-medium text-richblack-5 outline-none ' />
                      </label>
                  )}
