  ...
  return (
    <>
      <div className={`relative w-full bg-richblack-800`}>
        ...
        {/* Hero Section */}
        <div className="mx-auto box-content px-4 lg:w-[1260px] 2xl:r elative ">

          <div className="mx-auto grid min-h-[450px] max-w-m axContentTab justify-items-center py-8 lg:mx-0 lg:justify-items-start lg:py-0 xl:max-w-[810px]">
        ...
        <div className="mx-auto max-w-maxContentTab lg:mx-0 xl:max-w-[810px]">
          ...
          <div className="my-8 border border-richblack-600 p-8">
            ...
            <div className="mt-5">
              ...
              <p className='font-medium text-base text-[#C5C7D4] ' >{whatYouWillLearn}</p>
            </div>
          </div>
