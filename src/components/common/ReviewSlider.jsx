...
function ReviewSlider(){
  ...
  return (
    <div className="text-white">
      ...
      {/* freeMode={true} */}
        <Swiper className="w-full mySwiper" loop={true} slidesPerView={3} spaceBetween={25}  modules={[ Autoplay, Navigation, Pagination ]} pagination={true} autoplay={{delay: 2500,  disableOnInteraction: false, }}  >
