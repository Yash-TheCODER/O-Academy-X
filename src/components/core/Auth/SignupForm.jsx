...
function SignupForm() {
  ...
  return (
    ...
    <div className="bg-gray-800 p-6 rounded-lg border-1.5 border-gray-400 shadow-lg w-96 mt-0"
    >
      ...
      <form onSubmit={handleOnSubmit} className="flex w-full flex-col gap-y-4">
        ...
        <div className="flex gap-x-4">
          ...
          <label>   {/* First Name */}
              <p className="mb-1 text-[1rem] leading-[1.375rem] text-richblack"> First Name <sup className="text-pink-200">*</sup> </p>
              <input required type="text"  value = {firstName} onChange={handleOnChange} placeholder="Enter First Name" name="firstName"  style={{boxShadow: "inset 0px -1px 0px rgba(255, 255, 255, 0.18)", }}  className='bg-richblack-800 rounded-[0.5rem] text-richblack-5 w-full p-[12px]' />          
          </label>

          <label>    {/* Last Name */}
              <p className='text-[1rem] text-richblack mb-1 leading-[1.375rem]'> Last Name <sup className='text-pink-200'>*</sup></p>
              <input required type="text"  value = {lastName} onChange={handleOnChange} placeholder="Enter Last Name" name="lastName" style={{boxShadow: "inset 0px -1px 0px rgba(255, 255, 255, 0.18)", }} className='bg-richblack-800 rounded-[0.5rem] text-richblack-5 w-full p-[12px]' />
          </label>         
        ...
        <label className='w-full'>      {/* Email */}
             <p className='text-[1rem] text-richblack mb-1 leading-[1.375rem]'>Email Address<sup className='text-pink-200'>*</sup></p>
             <input required type="email"  value = {email} onChange={handleOnChange} placeholder="Enter Email Name" name="email" style={{boxShadow: "inset 0px -1px 0px rgba(255, 255, 255, 0.18)", }} className='bg-richblack-800 rounded-[0.5rem] text-richblack-5 w-full p-[12px]' />
        </label>
        ...
        <div className="flex gap-x-4">                          {/* createPassword and Confirm Password */}
            ...
            <label className='relative'>
                <p className='text-[1rem] text-richblack mb-1 leading-[1.375rem]'>Create Password<sup className='text-pink-200'>*</sup></p>
                <input  required  type = {showPassword ? ("text") : ("password")}  name="password"  onChange={handleOnChange}  value={password}  placeholder="Enter Pass" style={{boxShadow: "inset 0px -1px 0px rgba(255, 255, 255, 0.18)", }}  className='bg-richblack-800 rounded-[0.5rem] text-richblack-5 w-full p-[12px]' />
            ...
            <label className='relative'>
                <p className='text-[1rem] text-richblack mb-1 leading-[1.375rem]'>Confirm Password<sup className='text-pink-200'>*</sup></p>
                <input  required  type = {showConfirmPassword ? ("text") : ("password")}  name="confirmPassword"  onChange={handleOnChange}  value={confirmPassword}  placeholder="Confirm Pass" style={{boxShadow: "inset 0px -1px 0px rgba(255, 255, 255, 0.18)", }} className='bg-richblack-800 rounded-[0.5rem] text-richblack-5 w-full p-[12px]' />
            
                <span  className='absolute right-3 top-[38px] cursor-pointer' onClick={() => setShowConfirmPassword((prev) => !prev)}>
                    {showConfirmPassword ? (<AiOutlineEyeInvisible fontSize={20} fill='#AFB2BF'/>) : (<AiOutlineEye fontSize={24} fill='#AFB2BF'/>)}
                </span>
            </label>
