...
exports.capturePayment = async(req, res) => {
    ...
    for(const course_id of courses) {
        ...
        try{
            ...
            // user already pay for the same course-> In our Course model userid is stored as ObjectID that's why we need to convert it into ObjectID -> phle string type me thi ab objectid me convert kr rhe h
